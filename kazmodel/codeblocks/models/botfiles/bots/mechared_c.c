...
skill 1
{
	CHARACTERISTIC_NAME							"MechaRed"
	CHARACTERISTIC_GENDER						"male"
	CHARACTERISTIC_ATTACK_SKILL					0.5
	CHARACTERISTIC_WEAPONWEIGHTS				"bots/mechared_w.c"
	...
	CHARACTERISTIC_CHAT_FILE					"bots/mechared_t.c"
	CHARACTERISTIC_CHAT_NAME					"mechared"
	...
	CHARACTERISTIC_ITEMWEIGHTS					"bots/mechared_i.c"
